...
const TermsModal = ({ visible, onAccept, onClose }: TermsModalProps) => {
  return (
          ...
          <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={true}>
            ...
            <View style={styles.complianceBanner}>
              ...
              <View style={styles.complianceTextContainer}>
                ...
                <AppText style={styles.complianceDesc}>
                  ...
                  <AppText variant="bold">HANYA untuk anggota resmi</AppText> Koperasi Pinjaman PT. Bare Jaya Berdikari. Aplikasi ini mematuhi
                  Peraturan Kementerian Koperasi & UKM RI, Otoritas Jasa Keuangan (OJK), dan Kebijakan Layanan Keuangan Google Play Store.
                </AppText>
              </View>
            </View>
            ...
            <View style={styles.sectionCard}>
              ...
              <AppText style={styles.paragraph}>
                Dengan mengunduh, memasang, dan/atau menggunakan aplikasi Koperasi Pinjaman PT. Bare Jaya Berdikari ("Aplikasi"), Anda menyatakan
                bahwa Anda telah membaca, memahami, dan menyetujui seluruh ketentuan dalam Syarat dan Ketentuan Layanan ini. Jika Anda tidak
                menyetujui ketentuan ini, mohon untuk tidak melanjutkan penggunaan Aplikasi.
              </AppText>
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
                <AppText style={styles.bulletText}>
                  <AppText variant="bold">Pembatasan Anggota:</AppText> Layanan ini ditujukan secara eksklusif kepada Anggota Resmi Koperasi Pinjaman
                  PT. Bare Jaya Berdikari yang memiliki Nomor Baku Anggota (NBA).
                </AppText>
              </View>
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
            ...
            <View style={styles.sectionCard}>
              ...
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
                <AppText style={styles.bulletText}>
                  <AppText variant="bold">Monitoring Terbatas:</AppText> Nasabah/Anggota hanya diberikan akses khusus untuk memantau data tagihan,
                  sisa kewajiban, dan invoice masing-masing yang terdaftar atas nama mereka sendiri.
                </AppText>
              </View>
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
                <AppText style={styles.bulletText}>
                  <AppText variant="bold">Invoice Digital:</AppText> Aplikasi secara otomatis menerbitkan dan menyajikan rincian invoice tagihan
                  digital secara berkala sebagai bukti kewajiban pembayaran yang transparan.
                </AppText>
              </View>
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
            ...
            <View style={styles.sectionCard}>
              ...
              <View style={styles.simulationBox}>
                <View style={styles.simulationField}>
                  ...
                  <AppText style={styles.simValue}>
                    Tersedia pilihan Tenor Harian yaitu 36 Hari, 42 Hari, 60 Hari, 90 Hari, 120 Hari, dan 150 Hari yang disepakati bersama dalam
                    perjanjian fisik tertulis.
                  </AppText>
                </View>
                ...
                <View style={styles.simulationField}>
                  ...
                  <AppText style={styles.simValue}>Total suku bunga keseluruhan adalah 26% untuk jangka waktu pinjaman yang disepakati.</AppText>
                </View>
                ...
                <View style={styles.simulationField}>
                  ...
                  <AppText style={styles.simIntro}>
                    Jika Anggota memiliki Pinjaman sebesar <AppText variant="bold">Rp3.000.000</AppText> dengan tenor harian{' '}
                    <AppText variant="bold">90 Hari</AppText> dan total suku bunga keseluruhan <AppText variant="bold">26%</AppText>:
                  </AppText>
              ...
              <AppText style={styles.paragraph}>
                Aplikasi ini <AppText variant="bold">TIDAK MENAWARKAN</AppText> atau melakukan pencairan pinjaman online pribadi tanpa jaminan secara
                instan kepada masyarakat umum. Seluruh aktivitas kredit hanya dilakukan untuk anggota koperasi terdaftar yang disetujui secara luring
            ...
            <View style={styles.sectionCard}>
              ...
              <AppText style={styles.paragraph}>
                Privasi data Anda adalah prioritas kami. Seluruh informasi data pribadi yang dikumpulkan melalui Aplikasi diatur dalam Kebijakan
                Privasi Koperasi Pinjaman PT. Bare Jaya Berdikari.
              </AppText>
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
                <AppText style={styles.bulletText}>
                  <AppText variant="bold">Tujuan Pengumpulan:</AppText> Data KTP, Informasi Keuangan, dan NBA dikumpulkan secara khusus untuk
                  verifikasi status keanggotaan koperasi dan kepatuhan prinsip Mengenal Nasabah (Know Your Customer - KYC).
                </AppText>
              </View>
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
                <AppText style={styles.bulletText}>
                  <AppText variant="bold">Enkripsi Data:</AppText> Semua transmisi data pribadi dan transaksi finansial dienkripsi dengan aman
                  menggunakan teknologi SSL/HTTPS berkekuatan tinggi guna mencegah penyadapan data.
                </AppText>
              </View>
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
            ...
            <View style={styles.sectionCard}>
              ...
              <AppText style={styles.paragraph}>
                Koperasi Pinjaman PT. Bare Jaya Berdikari berupaya semaksimal mungkin menyediakan sistem teknologi yang andal, aman, dan tanpa
                kendala. Namun:
              </AppText>
              <View style={styles.bulletItem}>
                <AppText style={styles.bulletSymbol}>•</AppText>
            ...
            <View style={styles.sectionCard}>
              ...
              <AppText style={styles.paragraph}>
                ...
                mufakat. Apabila kesepakatan tidak tercapai, perselisihan akan diselesaikan melalui jalur hukum resmi di Pengadilan Negeri yang
            ...
            <View style={{ marginVertical: 16 }}>
              <AppText style={styles.termsParagraph}>
                Dengan mengeklik tombol "Saya Setuju", Anda menyatakan telah membaca, memahami, dan menyetujui seluruh ketentuan di atas.
              </AppText>
            </View>
          </ScrollView>
          <Button title="Saya Setuju" type="default" size="medium" style={styles.modalAcceptButton} onPress={onAccept} />
        </View>
      </View>
    </Modal>
  );
